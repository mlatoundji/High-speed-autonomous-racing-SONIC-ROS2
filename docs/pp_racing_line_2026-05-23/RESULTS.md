...
> **Re-run matrices:** [`scripts/configs/r1_pp_vs_stanley.yaml`](../../scripts/configs/r1_pp_vs_stanley.yaml) through [`r4_latency_sweep.yaml`](../../scripts/configs/r4_latency_sweep.yaml) — see [`scripts/configs/README.md`](../../scripts/configs/README.md).
...
> Frozen snapshot per milestone goes to `snapshots/<milestone>.csv`.
...
Plot: `figures/r1_controller_compare.png` (matplotlib install pending on the dev machine).
...
Plot: `figures/r2_tuning_sweep.png` (TODO).
...
Plot: `figures/r3_trajectory_xy.png` -- to be regenerated once matplotlib is unbroken on the dev machine. The XY trajectory comparison would visually show the racing line cutting every apex.
...
Plot `figures/r4_latency.png`: still TODO once matplotlib is unbroken. Will plot best-lap-per-config vs latency to make the U curve obvious.
...
Plot: `figures/r4_latency.png` -- to be generated once the full sweep is complete.
...
Plot: `figures/r5_odom_noise.png`.
